...
export default class MovieInfo extends Component {
  ...
  fetchMovie = () => {
    const urlMovie = fetch(
      ...
      }?api_key=80ed461d05b7e155c56d598a9495315e&language=pt-BR`
    );
    const urlCredits = fetch(`https://api.themoviedb.org/3/movie/${
      this.props.match.params.movie_id
    }/credits?api_key=80ed461d05b7e155c56d598a9495315e&language=pt-BR
        `);
    const urlVideos = fetch(`https://api.themoviedb.org/3/movie/${
      this.props.match.params.movie_id
    }/videos?api_key=80ed461d05b7e155c56d598a9495315e&language=pt-BR
          `);
